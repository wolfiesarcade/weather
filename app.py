...
def cityName():
        ...
        return render_template("weather.html", weather=weather, celsius=celsius, farh=farh, temperature=temperature, iconexecute=iconexecute, cityname=city, videoexecute=videoexecute, current_date=current_date)
